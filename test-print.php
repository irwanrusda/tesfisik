...
?>
<!doctype html><html lang="id"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Blanko <?= e($test['athlete_name']) ?></title><link rel="stylesheet" href="<?= e(base_url('assets/css/print.css')) ?>"></head><body>
...
<main class="print-sheet">
    <header class="print-header"><div class="print-logo">KONI<br><small>SUMBAR</small></div><div><h1>BLANKO TES FISIK ATLET SUMBAR</h1><h2>TAHUN 2026</h2></div><div class="test-number"><?= e($test['test_number']) ?></div></header>
