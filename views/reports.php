...
<section class="panel">
    ...
    <?php foreach ($tests as $item): ?><tr>
        <td><span class="code-pill"><?= e($item['test_number']) ?></span></td><td><strong><?= e($item['athlete_name']) ?></strong><small class="cell-subtext"><?= e(calculate_age($item['birth_date'], $item['test_date'])) ?> tahun</small></td><td><?= e($item['sport']) ?></td><td><?= e($item['gender']) ?></td><td><?= e(format_date($item['test_date'])) ?></td><td><?= e($item['bmi']) ?></td>
        <td><div class="action-row"><a class="btn btn-small btn-light" href="<?= e(base_url('test-view.php?id=' . $item['id'])) ?>">Detail</a><a class="btn btn-small btn-outline" target="_blank" href="<?= e(base_url('test-print.php?id=' . $item['id'])) ?>">Cetak</a></div></td>
    </tr><?php endforeach; ?>
    </tbody></table></div>
</section>
