<div class="page-heading">
    ...
    <div class="button-row"><a class="btn btn-light" href="<?= e(base_url('test-edit.php?id=' . $test['id'])) ?>">Edit Data</a><a class="btn btn-primary" target="_blank" href="<?= e(base_url('test-print.php?id=' . $test['id'])) ?>">Cetak Blanko</a></div>
</div>
