<div class="page-heading">
    ...
    <div class="button-row"><?php if (in_array(Auth::user()['role'] ?? '', ['superadmin', 'panitia', 'input'], true) && !crud_locked_for_current_user()): ?><a class="btn btn-light" href="<?= e(base_url('test-edit.php?id=' . $test['id'])) ?>">Edit Data</a><?php endif; ?><a class="btn btn-primary" target="_blank" href="<?= e(base_url('test-print.php?id=' . $test['id'])) ?>">Cetak Blanko</a></div>
</div>
